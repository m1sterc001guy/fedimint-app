...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1313429182;
...
abstract class RustLibApi extends BaseApi {
  ...
  int crateNostrPublicFederationAutoAccessorGetNumReviews({
    required PublicFederation that,
  });
  ...
  void crateNostrPublicFederationAutoAccessorSetNumReviews({
    required PublicFederation that,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  int crateNostrPublicFederationAutoAccessorGetNumReviews({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateNostrPublicFederationAutoAccessorGetNumReviewsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateNostrPublicFederationAutoAccessorGetNumReviewsConstMeta =>
      const TaskConstMeta(
        debugName: "PublicFederation_auto_accessor_get_num_reviews",
        argNames: ["that"],
      );
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_u_32(numReviews, serializer);
          return pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 149,
        ...
        constMeta:
            kCrateNostrPublicFederationAutoAccessorSetNumReviewsConstMeta,
        argValues: [that, numReviews],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateNostrPublicFederationAutoAccessorSetNumReviewsConstMeta =>
      const TaskConstMeta(
        debugName: "PublicFederation_auto_accessor_set_num_reviews",
        argNames: ["that", "numReviews"],
      );
...
class PublicFederationImpl extends RustOpaque implements PublicFederation {
  ...
  int get numReviews => RustLib.instance.api
      .crateNostrPublicFederationAutoAccessorGetNumReviews(that: this);
  ...
  set numReviews(int numReviews) =>
      RustLib.instance.api.crateNostrPublicFederationAutoAccessorSetNumReviews(
        that: this,
